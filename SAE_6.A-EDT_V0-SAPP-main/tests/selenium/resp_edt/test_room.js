...
describe("add room Test", function () {
  ...
  it("add room step", async function () {
    await driver
      .findElement(By.xpath('//*[@id="cal-date-nav-buttons"]/div[2]/button[2]'))
      .click();
    await driver.findElement(By.xpath('//*[@id="choix"]')).click();
    await selectFirst(driver, '//*[@id="choix"]');
    await driver
      .findElement(By.xpath('//*[@id="accordion-collapse-heading-1"]/button'))
      .click();
    await driver.findElement(By.xpath('//*[@id="name"]')).sendKeys("B1-01");
    await driver.findElement(By.xpath('//*[@id="ordi"]')).sendKeys("30");
    await driver.findElement(By.xpath('//*[@id="ordi"]')).sendKeys("30");
    await driver
      .findElement(By.xpath('//*[@id="videoProjecteur"]'))
      .sendKeys("1");
    await driver
  ...
  it("delete room step", async function () {
    ...
    await driver
      .findElement(
        By.xpath(
          '//*[@id="accordion-collapse-body-2"]/div/div[3]/table/tbody/tr[11]/td[5]/a'
        )
      )
      .click();
    await driver
